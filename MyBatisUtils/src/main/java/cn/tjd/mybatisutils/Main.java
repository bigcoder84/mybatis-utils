...
public class Main {
    ...
    private static void initCliArgs(String[] args) throws ParseException {
        ...
        // help
        OPTIONS.addOption(Option.builder().hasArg(false).longOpt("help").type(String.class).desc("Get help " +
                "information.").build());
        ...
        OPTIONS.addOption(Option.builder().hasArg(true).longOpt("database").type(String.class).desc("Database port" +
                ".You can also specify the 'DATABASE_NAME' property in the config.properties configuration file under" +
        ...
        OPTIONS.addOption(Option.builder().hasArg(true).longOpt("table").type(String.class).desc("Database table name" +
                ".You can also specify the 'TABLE_NAME' property in the config.properties configuration file under " +
                "the current path.").build());
    ...
    private static void analyzeArgs() throws SQLException {
        ...
        TableInfo tableInfo = TableInfo.tableInfo(IP, PORT, USERNAME, PASSWD, DATABASE_NAME, TABLE_NAME);
